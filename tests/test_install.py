...
class InstallTests(unittest.TestCase):
    ...
    def test_parent_can_install_alone(self):
        ...
        self.assertFalse((self.dest / "high-output-management").exists())
    ...
    def test_concurrent_user_file_is_preserved(self):
        ...
        self.assertEqual(installer.hashes(REPO / "skills/high-output-management"),
                         installer.hashes(self.dest / "high-output-management"))
    ...
    def test_publish_failure_removes_only_empty_reservation(self):
        ...
        self.assertTrue((self.dest / "high-output-management/SKILL.md").is_file())
